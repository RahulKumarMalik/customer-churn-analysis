...
`MySQL` · `Window Functions (NTILE, PERCENT_RANK, RANK)` · `CTEs` · `Cohort Analysis` · `RFM Segmentation` · `Advanced Excel` · `Churn Risk Scoring` · `Revenue Recovery Modelling` · `MIS Reporting` · `GitHub Pages` · `Data Visualisation` · `Retention Strategy`
